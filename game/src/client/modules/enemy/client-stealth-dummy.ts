...
export class ClientStealthDummy extends ClientEnemy {
	constructor(id: string, cframe: CFrame) {
		const dummyModel = ReplicatedStorage.assets.enemies.models.stealthDummy.Clone();
	...
	start() {
		...
		walkAnimation.AnimationId = "rbxassetid://16775949590";
